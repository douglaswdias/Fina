...
public class CategoryHandler(AppDbContext context) : ICategoryHandler
{
    ...
    public async Task<Response<Category?>> DeleteAsync(DeleteCategoryRequest request)
    {
        ...
        {
            return new Response<Category?>(null, 500, "Erro ao apagar categoria");
        }
    }
    ...
    public async Task<Response<Category?>> GetByIdAsync(GetCategoryByIdRequestt request)
    {
        ...
        {
            return new Response<Category?>(null, 500, "Não foi possível carregar a categoria");
        }
    }
    ...
    public async Task<PagedResponse<List<Category?>>> GetAllAsync(GetAllCategoriesRequest request)
    {
        ...
        {
            return new PagedResponse<List<Category?>>(null, 500, "Não foi possível carregar as categorias");
        }
    }
}